...
public class ReportNGListener extends BaseTest implements ITestListener {
	...
	public void onTestFailure(ITestResult result) {
		...
		//Way1. Take screenshot to image file
//		String screenshotPath = captureScreenshot(webDriver, result.getName());
//		Reporter.getCurrentTestResult();
//		Reporter.log("<br><a target=\"_blank\" href=\"file:/" + screenshotPath + "\">" + "<img src=\"file:///" + screenshotPath + "\" " + "height='100' width='150'/> " + "</a></br>");
		
		//Way2. Take screenshot to base64
		String base64ScreenShot = captureBase64Screenshot(webDriver);
		Reporter.getCurrentTestResult();
		Reporter.log("<br><a target=\"_blank\" href='data:image/jpeg;base64, " + base64ScreenShot + "'>" + "<img src='data:image/jpeg;base64, " + base64ScreenShot + "'\" " + "height='100' width='150'/> " + "</a></br>");
